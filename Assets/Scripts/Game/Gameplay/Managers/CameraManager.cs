...
namespace Game.Gameplay.Managers
{
    public class CameraManager : MonoBehaviour
    {
        ...
        [field: SerializeField] public float Angle { get; private set; } = 45;
        [field: SerializeField] public float AngleY { get; private set; } = 45;
        [field: SerializeField] public float Radius { get; private set; } = 30;
        [field: SerializeField] public float Padding { get; private set; } = 1;
